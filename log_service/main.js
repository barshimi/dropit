'use strict';
/**
 * log service entry for microservice
 */
var config = require('./log_constants'),
...
app.init = co.wrap((ctx, next) => {
   ...
   let rabbitMQconsumer = require('./rabbitMQconsumer');
   ...
   */
   ...
   /**  router **/
    Router
      .post('/loginfo', require('./recieveLogsCtrl').storeLogsInfo)
      .del('/loginfo/:id', require('./recieveLogsCtrl').deleteLogsInfo)
      .get('/*', (ctx, next) => {
